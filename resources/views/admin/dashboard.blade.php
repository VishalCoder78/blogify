        ...
        @foreach ($blogs as $blog)
            <div>
                ...
                <div class="w-[40rem] mx-auto my-20">
                    <a href="blog/{{ $blog->id }}" class=" text-4xl text-gray-300 font-bold my-4 leading-10">{{ $blog->blog_title }}</a>
                    <div class="flex py-4">
                        <span class="mt-0.5">
                    ...
                    <a href="blog/{{ $blog->id }}" class="inline-flex items-center mt-8 px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Read more
